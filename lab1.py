...
d1 = {0: 'нуля', 1: 'единицы', 2: 'двойки', 3: 'тройки', 4: 'четвёрки', 5: 'пятёрки', 6: 'шестёрки', 7: 'семёрки', 8: 'восмёрки', 9: 'девятки',}
d2 = {0: 'нуль', 1: 'единица', 2: 'двойка', 3: 'тройка', 4: 'четвёрка', 5: 'пятёрка', 6: 'шестёрка', 7: 'семёрка', 8: 'восмёрка', 9: 'девятка',}
d3 = {0: 'нулей', 1: 'единиц', 2: 'двоек', 3: 'троек', 4: 'четвёрок', 5: 'пятёрок', 6: 'шестёрок', 7: 'семёрок', 8: 'восмёрок', 9: 'девяток',}
buffer = ''
buffer_len = 1
work_buffer = ''
